...
- `web-admin-panel/`: Web Admin Dashboard & REST API backend untuk manajemen lisensi berbasis Express.js & Tailwind CSS.
...
Aplikasi iOS terhubung langsung dengan backend **Web Admin Panel**:
